...
Presto.Staff = Presto.Grob.extend({
   ...
   * specific event, and if yes, it will return the notated object (a Presto.NoteColumn)
  ...
  advanceCursor: function (stepSize) {
    ...
    // check for beaming
    // we need to know whether the note column contains an 8th, and if yes, and no beam exists, create one
